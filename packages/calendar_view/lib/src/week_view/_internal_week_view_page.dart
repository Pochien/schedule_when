...
class InternalWeekViewPage<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //   if (date.day == 14) {
    //     debugPrint("Events on $date: ${controller.getEventsOnDay(date)}");
    //     debugPrint("InternalWeekViewPage building ...");
    //   }
    // }

    // debugPrint("width in InternalWeekViewPage: $width");
    // debugPrint(
    //     "weekTitle (width, height): ($weekTitleWidth, $weekTitleHeight)");
