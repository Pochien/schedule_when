...
class Constants {
  ...
  static const int clockStart = 8;
  static const int clockEnd = 20;
  ...
  // EventTile
  /// EventTileSidePadding: the padding size for left side and right side space.
  static const double eventTileSidePadding = 1;
}
