    ...
    return ConstrainedBox(
      ...
      child: Stack(
        children: [
          ...
          for (int i = clockStart; i < clockEnd; i++)
            Positioned(
...
class EventGenerator<T> extends StatelessWidget {
  ...
  List<Widget> _generateEvents() {
    /// OrganizedCalendarEventData List
    ...
    return List.generate(events.length, (index) {
      return Positioned(
        top: events[index].top - clockStart * 60,
        bottom: events[index].bottom + clockStart * 60,
